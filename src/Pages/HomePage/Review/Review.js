...
const Review = () => {
    return (
        <div className="p-12 bg-gradient-to-l from-blue-900 via-slate-900 to-black">
            <section className="my-8">
                ...
                <div className="container mx-auto grid grid-cols-1 gap-8 lg:gap-20 md:px-10 md:pb-10 lg:grid-cols-2">
                    <div className="flex flex-col items-center mx-12 lg:mx-0">
                        ...
                        <p className="text-cyan-300 text-lg font-semibold">S M Zubayer</p>
                    </div>
                    <div className="flex flex-col items-center max-w-lg mx-12 lg:mx-0">
                        ...
                        <span className="w-12 h-1 my-2 rounded-lg bg-violet-400"></span>
                        <p className="text-cyan-300 text-lg font-semibold">Sabit Bonani</p>
                    </div>
                </div>
            </section>
        </div>
