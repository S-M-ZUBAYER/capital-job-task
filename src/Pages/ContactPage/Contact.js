...
const Contact = () => {
    ...
    return (
        <div>
            <section className="min-h-screen text-gray-200 bg-gradient-to-l from-blue-900 via-slate-900 to-black">
                <div className="container px-6 py-10 mx-auto">
                    <div className="lg:flex lg:items-center lg:-mx-10">
                        <div className="lg:w-1/2 lg:mx-10">
                            <h1 className="text-3xl font-semibold text-gray-200 capitalize dark:text-white lg:text-5xl">Let’s talk</h1>
                            ...
                            <form className="mt-12 text-gray-200">
                                ...
                                <button className="w-full px-6 py-3 mt-4 text-sm font-medium tracking-wide text-gray-200 capitalize transition-colors duration-300 transform bg-blue-500 rounded-md hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                                    get in touch
                                </button>
                            </form>
                        </div>
